...
public class Pantalla {
	...
	private PImage modelCompaX,modelCompaS,modelCompa3,modelCompaY;
	...
	int precio;
	int comparacion;
	//Varaibles para controlar el tamaño de las graficas
	int tam;
	int tam2;
	int tam3;
	int tam4;
	...
	int modeloComparadoAu;
	int modeloComparadoV;
	int modeloComparadoR;
	...
	//aca cargo todas las imagenes que voy a usar 
		...
		modelCompaX=app.loadImage("img/pComparacionX.png");
...
//Con este metodo pinto todas las pantallas y todo lo que necesite 
	...
	public void pasarPantalla() {
		...
		//pantalla de exito de registro
				...
				if((app.mouseX>57 &&app. mouseX<166)&&(app.mouseY>588 && app.mouseY<620)) {
					...
					pantalla=21;
					//aparece el modelo de carro a comparar
					comparacion=0;
					}
				break;
				...
				case 21:if((app.mouseX>27 && app.mouseX<81)&&(app.mouseY>31 && app.mouseY<70)) {
					pantalla=3;
					}
	...
	//Todos los graficas para comparar los datos
	//aceleracion
	...
	public void compararAutonomia() {
		...
		app.noStroke();
		app.fill(230,35,41);
		app.rect(39,449,tam2,19);
		
	
		//con este switch controlo los datos de cada modelo, los que van a ser comparados
	switch(modeloComparadoAu) {
	case 0:
		if(app.frameCount==10) {
			tam2=20;
		}
	...
	public void compararVelocidad() {
		...
		app.noStroke();
		app.fill(230,35,41);
		app.rect(39,528,tam3,19);
		
	
		//con este switch controlo los datos de cada modelo, los que van a ser comparados
	switch(modeloComparadoV) {
	case 0:
		if(app.frameCount==10) {
			tam3=20;
		}
	...
	//comparo velocidad
		public void compararRines() {
			...
			app.noStroke();
			app.fill(230,35,41);
			app.rect(38,610,tam4,19);
			
		
			//con este switch controlo los datos de cada modelo, los que van a ser comparados
		switch(modeloComparadoR) {
		case 0:
			if(app.frameCount==10) {
				tam4=20;
			}
		...
		public void compararOtroCarro() {
			...
			app.noStroke();
			app.fill(230,35,41);
			app.rect(233,370,tam1C,19);
			app.rect(233,449,tam2C,19);
			app.rect(233,528,tam3C,19);
			app.rect(233,610,tam4C,19);
		...
		public void tipoCarroCompa() {
			switch(comparacion) {
			case 0:app.image(modelCompaS,0,0);  
				break;
			case 1:app.image(modelCompa3,0,0);   
			break;
			case 2:app.image(modelCompaX,0,0);  
			break;
			case 3:app.image(modelCompaY,0,0);   
			break;
			}
